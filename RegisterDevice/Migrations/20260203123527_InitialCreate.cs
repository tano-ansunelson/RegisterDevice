    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeviceCheckResults", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyDevices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceImages_MyDevices_RegisteredDeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceImages_RegisteredDeviceId",
                table: "DeviceImages",
                column: "RegisteredDeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_MyDevices_UserId",
                table: "MyDevices",
                column: "UserId");
        }
